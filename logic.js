...
function createMap(earthquakes) {
  ...
  var darkmap = L.tileLayer(
    ...
    {
      attribution: "Map data &copy; <a href='https://www.openstreetmap.org/'>OpenStreetMap</a> contributors, " +
        "Tiles courtesy of <a href='https://carto.com/attributions'>CARTO</a>",
      maxZoom: 18
    }
  );
  ...
  // Add the base map layer control to the map
  L.control.layers(baseMaps, overlayMaps).addTo(myMap);

  // Define a getColor function to determine the marker color based on magnitude
  function getColor(d) {
    return d < 1
      ? "rgb(255,255,255)"
      : d < 2
